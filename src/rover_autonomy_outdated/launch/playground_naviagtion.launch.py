...
def generate_launch_description():
    ...
    """
    my_package_name = 'rover_autonomy_outdated'
    ...
    remappings = [('/tf', 'tf'), ('/tf_static', 'tf_static'), ('/map', '/mapping/map')]
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(my_package_dir, 'config', 'nav2_params.yaml'),
